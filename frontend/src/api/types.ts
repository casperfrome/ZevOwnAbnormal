...
export interface AnomalyRecord { id: Id; title?: string; anomaly_key?: string; rule_id?: Id; rule_name?: string; severity: Severity; status: RecordStatus; assignee?: string; detected_at?: string; created_at?: string; push_status?: string; data?: Record<string, unknown>; matched_conditions?: unknown[]; timeline?: unknown[]; deliveries?: unknown[]; [key: string]: unknown }
export interface AnomalyGroup { id: Id; rule_id?: Id; rule_name?: string; anomaly_key?: string; status?: string; severity?: Severity; record_count?: number; first_detected_at?: string; last_detected_at?: string; records?: AnomalyRecord[]; [key: string]: unknown }
export interface Overview { stats?: Record<string, number>; trends?: Array<Record<string, unknown>>; severity_distribution?: Array<Record<string, unknown>>; [key: string]: unknown }
